...
# check if endWeek in data is much earlier than updateWeek (meaning that we have actual weeks with zero detections) and if so check if 2 concequetive weeks within that timeframe is NA - set them to zero
for(i in 1:diff) {
